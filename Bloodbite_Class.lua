masteryPos = {
  ...
  [1] = {x=-0.6800778577909695, y=0.11, z=0.6851211387123921},
  --[] Prevent your allies from suffering attack damage in a single scenario
  [2] = {x=-0.6800778577909695, y=0.11, z=0.8175594079040418},
}
perkPos = {
  --[][] Replace one [-1] card with one "[shield] 1" -rolling card
  [1] = {x=0.16235774353507937, y=0.11, z=-0.6248805690509853},
  [2] = {x=0.2052820484071266, y=0.11, z=-0.6248805690509853},
  ...
  [5] = {x=0.16235774353507937, y=0.11, z=-0.3295457640467274},
  [6] = {x=0.2052820484071266, y=0.11, z=-0.3295457640467274},
  --[][][] Add two "[heal] 1, [target] [icon2]" -rolling cards
  [7] = {x=0.16235774353507937, y=0.11, z=-0.2065329563720341},
  [8] = {x=0.2052820484071266, y=0.11, z=-0.2065329563720341},
  [9] = {x=0.24820635327917384, y=0.11, z=-0.2065329563720341},
  --[][] Add one "muddle, if the target is muddle, disarm instead" -rolling card
  [10] = {x=0.16235774353507937, y=0.11, z=-0.0840347982550135},
  [11] = {x=0.2052820484071266, y=0.11, z=-0.0840347982550135},
  --[] Add one "The target treats you as if you had invisible this round" card
  [12] = {x=0.16235774353507937, y=0.11, z=0.038978048750941435},
  --[] Ignore scenario effects
  [13] = {x=0.16235774353507937, y=0.11, z=0.16147620686796202},
  ...
  [14] = {x=0.16235774353507937, y=0.11, z=0.23466523432700367},
  --[|] You and your summons may [icon] onto the same figure, and your summons may [icon] onto you
  [15] = {x=0.16235774353507937, y=0.11, z=0.455267122196094},
  [16] = {x=0.16235774353507937, y=0.11, z=0.4828095276684965},
  --[|] Once each scenario, when you would suffer damage, instead gain stun and invisible, and perform "[teleport] 2"
  [17] = {x=0.16235774353507937, y=0.11, z=0.6267275879065495},
  [18] = {x=0.16235774353507937, y=0.11, z=0.654269993378952},
}
