...
perkPos = {
  ...
  --[][] Add one [+1] stun card
  [11] = {x=0.16235935039370078, y=0.11, z=-0.09879401918090971},
  [12] = {x=0.20528749999999998, y=0.11, z=-0.09879401918090971},
  --[] Ignore scenario effects, and you may start a scenario [icon3] onto an ally
  [13] = {x=0.16235935039370078, y=0.11, z=-0.011291816648626912},
  --[] You are immune to forced movement while [icon3], and whenever you would gain immobilize while [icon3], prevent the condition
  [14] = {x=0.16235935039370078, y=0.11, z=0.17369572331160163},
  ...
  [15] = {x=0.16235935039370078, y=0.11, z=0.4079797115312005},
  --[||] Whenever a new room is revealed, you may [icon] onto the nearest newly revealed enemy and control it [move] 2, [attack] 2 [target] 2
  [16] = {x=0.16235935039370078, y=0.11, z=0.7394469756085282},
  [17] = {x=0.16235935039370078, y=0.11, z=0.7669919067108905},
  [18] = {x=0.16235935039370078, y=0.11, z=0.7945368378132527},
}
